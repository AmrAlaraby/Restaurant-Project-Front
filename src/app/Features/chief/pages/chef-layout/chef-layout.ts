...
export class ChefLayout {
  ...
  chefSidebarData = [
  {
    title: 'CHEF.SIDEBAR.KITCHEN',
    links: [
      {
        title: 'CHEF.SIDEBAR.KITCHEN_BOARD',
        route: 'kitchen',
  ...
  {
    title: 'CHEF.SIDEBAR.INVENTORY',
    links: [
      {
        title: 'CHEF.SIDEBAR.CHECK_STOCK',
        route: 'stock',
  ...
  {
    title: 'CHEF.SIDEBAR.ACCOUNT',
    links: [
      {
        title: 'CHEF.SIDEBAR.PROFILE',
        route: 'profile',
        icon: `<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round">
